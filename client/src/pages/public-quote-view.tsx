...
import { Check, X, Download, Phone, Mail, MapPin, Loader2 } from "lucide-react";
        ...
        {quote.status === "accepted" && (
          <Card className="p-6 text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Merci ! Nous vous contacterons prochainement pour fixer un rendez-vous.
            </p>
            {garage?.phone && (
              <p className="text-sm">
                Appelez-nous au <a href={`tel:${garage.phone}`} className="font-medium underline" style={{ color: primaryColor }}>{garage.phone}</a>
              </p>
            )}
          </Card>
        )}
