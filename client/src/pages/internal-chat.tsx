...
interface ConversationListProps {
  ...
  conversationType: "internal" | "client_admin";
  onConversationTypeChange: (type: "internal" | "client_admin") => void;
}
              ...
              <div className="space-y-4 mt-4">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant={conversationType === "internal" ? "default" : "outline"}
                      size="sm"
                      onClick={() => onConversationTypeChange("internal")}
                    ...
                    <Button
                      variant={conversationType === "client_admin" ? "default" : "outline"}
                      size="sm"
                      onClick={() => onConversationTypeChange("client_admin")}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={conversationType === "client_admin" ? "Ex: Discussion avec M. Dupont" : "Ex: Projet réparation"}
                    data-testid="input-conversation-title"
                  />
                </div>
                <div className="space-y-2">
                  <Label>
                    {conversationType === "client_admin" ? "Sélectionner le client" : "Participants"}
                  </Label>
                  <ScrollArea className="h-48 border rounded-md p-3">
                    {chatUsers
                      .filter(u => u.id !== currentUserId)
                      .filter(u => conversationType === "client_admin" 
                        ? u.role === "client" 
                        : u.role !== "client"
                      )
                      .map((chatUser) => (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      ...
                      {(conv as any).type === "client_admin" && (
                        <Badge variant="outline" className="text-[10px] px-1 py-0">Client</Badge>
                      )}
                    </div>
                  </div>
                </div>
...
export default function InternalChat() {
  ...
  const [conversationType, setConversationType] = useState<"internal" | "client_admin">("internal");
  ...
  }, [newConversationTitle, selectedParticipants, conversationType, createConversationMutation, toast]);
