...
function GarageLegalSection() {
  ...
  if (!garageLegal) {
    return <p className="text-sm text-muted-foreground">Aucun garage associé à votre compte.</p>;
  }

  const fields: { key: keyof GarageLegalInfo; label: string; placeholder: string; group: string }[] = [
    { key: "name", label: "Raison sociale", placeholder: "AUTOREPORT", group: "identity" },
    ...
    { key: "email", label: "Email", placeholder: "contact@autoreport.com", group: "contact" },
    { key: "website", label: "Site web", placeholder: "https://autoreport.com", group: "contact" },
...
export default function AdminSettings() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      dailyReportRecipients: "contact@autoreport.com",
      customFields: [],
    },
  });
  ...
  useEffect(() => {
    if (settings) {
      form.reset({
        ...
        dailyReportRecipients: (settings as any).dailyReportRecipients || "contact@autoreport.com",
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="contact@autoreport.com, autre@email.com"
                            {...field}
                            value={field.value || ""}
