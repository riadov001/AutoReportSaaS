...
export function UserMenu() {
  ...
  const getRoleLabel = (role?: string) => {
    switch (role) {
      case "rootadmin": return "Root Admin";
  ...
  const getRoleBadgeClass = (role?: string) => {
    switch (role) {
      case "rootadmin": return "bg-rose-600 text-white border-rose-700 hover:bg-rose-600";
      case "superadmin": return "bg-purple-600 text-white border-purple-700 hover:bg-purple-600";
      case "admin": return "bg-blue-600 text-white border-blue-700 hover:bg-blue-600";
      case "employe": return "bg-emerald-600 text-white border-emerald-700 hover:bg-emerald-600";
      default: return "";
    }
  };
        ...
        <DropdownMenuContent align="end" className="w-60">
          <DropdownMenuLabel className="font-normal">
            <div className="flex flex-col space-y-1">
              ...
              <Badge variant="outline" className={`w-fit mt-2 ${getRoleBadgeClass(user.role)}`}>
