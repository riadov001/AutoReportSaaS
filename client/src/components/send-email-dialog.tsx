...
export function SendEmailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] w-[95vw] p-4 sm:p-6 overflow-y-auto max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-4 py-4 flex-1">
          <div className="space-y-2">
            <Label htmlFor="recipient" className="text-sm font-semibold">Destinataire</Label>
            <Input
              id="recipient"
              type="email"
              value={recipient}
          ...
          <div className="space-y-2">
            <Label htmlFor="additional-recipients" className="text-sm font-semibold">Autres destinataires</Label>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center justify-between gap-4">
              <Label htmlFor="save-default" className="cursor-pointer text-xs font-medium text-muted-foreground leading-tight">
            ...
            <div className="flex items-center justify-between gap-4">
              <Label htmlFor="send-copy" className="cursor-pointer text-xs font-medium text-muted-foreground leading-tight">
                M'envoyer une copie
              </Label>
              <Switch
                id="send-copy"
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2 flex-shrink-0 pt-4 border-t mt-auto">
          <Button
            variant="outline"
