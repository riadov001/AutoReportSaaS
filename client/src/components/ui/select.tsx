...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-foreground",
      ...
      "[&>span]:line-clamp-1",
      "dark:border-zinc-700 dark:bg-zinc-900 dark:text-foreground dark:hover:border-zinc-500 dark:hover:bg-zinc-800",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-md border border-zinc-700 bg-zinc-900 text-foreground shadow-xl",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("py-1.5 pl-8 pr-2 text-xs font-semibold uppercase tracking-wider text-zinc-500", className)}
    {...props}
  />
))
