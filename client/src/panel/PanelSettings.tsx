        ...
        {promptLoading ? (
          ...
          <>
            <p className="text-xs text-white/40 mb-3">
              Personnalisez les instructions système envoyées à l'IA lors de la génération de rapports. Laissez vide pour utiliser le prompt par défaut.
            </p>
            <textarea
              value={prompt}
              ...
              disabled={!isAdmin}
              rows={8}
              placeholder="Ex: Tu es un expert en diagnostic automobile spécialisé en véhicules de luxe. Donne des analyses détaillées et professionnelles..."
              data-testid="textarea-ai-prompt"
              className="w-full bg-white/[0.04] border border-white/[0.08] rounded-md px-4 py-3 text-white placeholder:text-white/20 text-sm focus:outline-none focus:border-[#CE1126]/40 resize-none disabled:opacity-40 disabled:cursor-not-allowed"
            />
            {isAdmin && (
